...
public class FXMainPane extends BorderPane {
	...
	private void buildUI() {
		...
		descriptionForInputLabel = new Label(
				"Enter a key (keyword for Vigenere and Playfair; shift number for Caesar)");
		...
		// Center Fields
		VBox centerBox = new VBox(10, plainTextLabel, plainTextTextField, encryptedLabel3, encryptedStringTextField3,
